<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Seller.Master" AutoEventWireup="true" CodeBehind="editseller.aspx.cs" Inherits="ArtGallery.editseller" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <link href="css/editSeller.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        .auto-style1 {
            height: 29px;
        }
